  ...
  <div className="w-full flex flex-row items-center hover:bg-[#4c426e] py-2 p-4 rounded-lg cursor-pointer mb-2 " >
    ...
    <div className='flex-1 flex flex-row justify-between items-center' >
      ...
      <div className='flex-1 flex flex-col justify-center mx-3' >
        ...
        <Link href={`/artists/${song.artists ? song?.artists[0].adamid : ''}`} >
...
const TopPlay = () => {
  ...
  if (error || (data && data.error != undefined)) return <Error message={data?.error} />;
  if (!data || isFetching == true) return <Loader title={'Loading Songs...'}/>;
    ...
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col" >
      ...
      <div className="w-full flex flex-col mt-8" >
        <div className="flex flex-row justify-between items-center">
            ...
            <Swiper slidesPerView="auto" spaceBetween={15} freemode={true} centeredSlides centeredSlidesBounds modules={[FreeMode]} className="mt-4" >
              {topPlays?.map((song,i)=>(
